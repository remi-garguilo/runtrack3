    ...
    <div class="container-fluid bg-secondary d-flex flex-column">
        ...
        <div>
            <div class="alert alert-secondary m-2" role="alert">
                ...
                <p class="mt-3">Il existe plusieurs visions du terme:</p>
                <p class="mt-3">le monde est la matière, l'espace et les phénomènes qui nous sont accessibles par les sens, l'experience ou la raison.</p>
                <p class="mt-3 mb-3">Le sens le plus courant désigne notre planète, la Terre, avec ses habitants, et son environnement plus ou moins naturel.</p>
                <hr>
            ...
            <div class="container d-flex flex-column justify-content-center col-9">
